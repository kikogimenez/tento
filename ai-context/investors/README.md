...
This folder contains the official investor documentation for Tento.
...
These documents represent the official narrative of the company and should be used as the primary reference when creating:
...
The messaging, positioning and storytelling should remain consistent with these documents.
